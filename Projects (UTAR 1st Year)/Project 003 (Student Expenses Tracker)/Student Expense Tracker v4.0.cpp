...
2. Sort Date & catergory (Done - v3.60)
3. Edit & Delete Expense (done - in this project)
*/
...
public:
    ...
    void editExpense() {
        ...
        int index;
        index = validInt("Enter the index you want to edit: ", 1, exp.size() + 1);
        ...
        do {
            ...
            switch (options) {
                case 1: {
                    ...
                    string newCate;
                    newCate = validStr("Enter new category: ", {"Food", "Rental", "Transportation", "Others"}, false);
